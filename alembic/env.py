...
from app.models.conversation import Conversation, ConversationParticipant  # noqa: F401 — Phase 9
from app.models.message import Message  # noqa: F401 — Phase 9: registers messages table
